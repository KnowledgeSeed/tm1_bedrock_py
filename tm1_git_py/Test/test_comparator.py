...
class TestComparator(unittest.TestCase):
    ...
    def test_comparison_modes_with_mock_data(self):
        changeset_full = self.comparator.compare(self.model1, self.model2, mode='full')
        ...
        changeset_add_only = self.comparator.compare(self.model1, self.model2, mode='add_only')
    ...
    def test_no_changes_with_mock_data(self):
        ...
        changeset = self.comparator.compare(self.model1, identical_model)
    ...
    def test_compare_full_vs_add_only_modes_with_real_data(self):
        ...
        changeset_full = comparator.compare(model1, model2, mode='full')
        ...
        changeset_add_only = comparator.compare(model1, model2, mode='add_only')
